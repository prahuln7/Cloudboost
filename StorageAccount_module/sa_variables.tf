variable "name" {
  type        = string
  description = "(Optional)The name of the storage account. When the variable name is left empty, than the resource group name must be in the Sogeti naming format."
  default     = ""
}
